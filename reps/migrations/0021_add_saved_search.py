...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reps_savedsearch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hashed_search', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('search', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('reps', ['SavedSearch'])


    def backwards(self, orm):
        
        # Deleting model 'SavedSearch'
        db.delete_table('reps_savedsearch')
    ...
    models = {
        ...
        'reps.savedsearch': {
            ...
            'hashed_search': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
