...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reps_house', 'name', orm['reps.house:name'])
        
        # Creating unique_together for [code] on House.
        db.create_unique('reps_house', ['code'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [code] on House.
        db.delete_unique('reps_house', ['code'])
