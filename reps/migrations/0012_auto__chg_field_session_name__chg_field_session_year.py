...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reps_session', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Session.year'
        db.alter_column('reps_session', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Session.name'
        db.alter_column('reps_session', 'name', self.gf('django.db.models.fields.CharField')(default='none', max_length=255))

        # Changing field 'Session.year'
        db.alter_column('reps_session', 'year', self.gf('django.db.models.fields.IntegerField')(default='none'))
